...
namespace PBL3.BLL
{
    ...
    {
        public bool CheckMHDCreateBill(string mhd)
        {
        ...
        public bool CheckMNVCreateBill(string mnv)
        {
        ...
        public void AddHoaDon(string mhd, string mnv, string mba)
        {
            using (PBL3Entities db = new PBL3Entities())
            {
        ...
        public List<ShowHoaDon> ShowHoaDonByMaHoaDon(string mhd)
        {
            PBL3Entities db = new PBL3Entities();
        ...
        public void ShowChiTietHoaDon(string mhd,string msp,int SL, bool MergeStatus)
        {
        ...
        public SANPHAM GetSanPhamByMaSanPham(string sp)
        {
        ...
        public List<SANPHAM> GetSanPhamByMaLoai(string ml)
        {
        ...
        public void AddChiTietHoaDon(string msp, string mhd, int SL)
        {
            using (PBL3Entities db = new PBL3Entities())
            {
        ...
        public void UpDateSoLuongAndGiaChiTietHoaDon(string msp, string mhd, int SL,bool MergeStatus)
        {
            using (PBL3Entities db = new PBL3Entities())
            {
        ...
        public void DeleteChiTietHoaDonByMaHoaDonAndMaSanPham(string mhd, string msp)
        {
            using (PBL3Entities db = new PBL3Entities())
            {
        ...
        public void DeleteChiTietHoaDon(string mhd)
        {
            using (PBL3Entities db = new PBL3Entities())
            {
        ...
        public void DeleteHoaDon(string mhd)
        {
            using (PBL3Entities db = new PBL3Entities())
            {
        ...
        public string Total(string mhd)
        {
            string tt;
            using (PBL3Entities db = new PBL3Entities())
            {
        ...
        public void CanCellOrder(string mhd,string mba)
        {
        ...
        public void UpDateStatusHoaDon(string mhd, bool tt)
        {
            using (PBL3Entities db = new PBL3Entities())
            {
        ...
        public string GetMaHoaDonByBan(string mb)
        {
            using(PBL3Entities db = new PBL3Entities())
            {
        ...
        public List<CHITIETHOADON> GetChiTietHoaDonByMaHoaDonAndMaSanPham(string hd, string msp)
        {
        ...
        public void ChangeTable(string mhd,string mba,string mb)
        {
        ...
        public  System.Drawing.Color StatusColor(bool tt)
        {
            if (tt == true)
