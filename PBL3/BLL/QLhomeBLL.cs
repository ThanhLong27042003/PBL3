...
namespace PBL3.BLL
{
    ...
    {
        public THONGTINTAIKHOAN GetInforByID(string id)
        {
        ...
        public void UpdateInfo(string id, string txt1, string txt2, string txt3, string txt4, string txt5)
        {
        ...
        public bool CheckPass(string id,string mkc, string mkm1, string mkm2)
        {
            using(PBL3Entities db=new PBL3Entities())
            {
      ...
      public void UpdatePass(string id,string mkm)
        {
            using(PBL3Entities db=new PBL3Entities())
            {
                var s=db.TAIKHOAN.Find(id);
