...
namespace PBL3.BLL
{
    internal class BieuDoBLL
    {
        ...
        public string TongDoanhThuTra(int thang, int nam)
        {
            ...
            {
                if (i.SANPHAM.Mã_loại == "201" && i.HOADON.Ngày_tạo.Month == thang && i.HOADON.Ngày_tạo.Year == nam && i.HOADON.Trạng_thái == true)
                {
                    tongtien += i.Giá_tiền;
                }
            }
        ...
        public string TongDoanhThuCaPhe(int thang, int nam)
        {
            ...
            foreach (CHITIETHOADON i in db.CHITIETHOADON)
            {
                if (i.SANPHAM.Mã_loại == "202" && i.HOADON.Ngày_tạo.Month == thang && i.HOADON.Ngày_tạo.Year == nam && i.HOADON.Trạng_thái == true)
                {
                    tongtien += i.Giá_tiền;
                }
            }
        ...
        public string TongDoanhThuTopping(int thang, int nam)
        {
            ...
            foreach (CHITIETHOADON i in db.CHITIETHOADON)
            {
                if (i.SANPHAM.Mã_loại == "203" && i.HOADON.Ngày_tạo.Month == thang && i.HOADON.Ngày_tạo.Year == nam && i.HOADON.Trạng_thái == true)
                {
                    tongtien += i.Giá_tiền;
                }
            }
