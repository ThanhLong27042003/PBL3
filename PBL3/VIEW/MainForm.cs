...
namespace PBL3
{
    ...
    {     
        ...
        public MainForm(string id,bool PQ)
        {
            InitializeComponent();
        ...
        {
            if (string.IsNullOrEmpty(textBox1.Text) || string.IsNullOrEmpty(textBox2.Text) || string.IsNullOrEmpty(textBox3.Text) || string.IsNullOrEmpty(textBox4.Text) || string.IsNullOrEmpty(textBox5.Text)) MessageBox.Show("vui long nhap day du thon tin");
            else 
            {
                QLhomeBLL bll = new QLhomeBLL();
                bll.UpdateInfo(MSNV, textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text);
            }
